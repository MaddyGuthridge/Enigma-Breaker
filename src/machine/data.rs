...
impl ReflectorId {
    ...
    fn get_reflector_config(
        &self
    ) -> [(Letter, Letter); NUM_LETTERS / 2] {
        match self {
            ReflectorId::A => todo!(),
            ReflectorId::B => [
                (Letter::A, Letter::Y),
